                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @EU_UV\
                                  \n\n--------بـدء تتبـع سجـل  𝙎𝙤𝙪𝙧𝙘𝙚 𝙋𝙧𝙤--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع زدثـــون 𝙎𝙤𝙪𝙧𝙘𝙚 𝙋𝙧𝙤--------"
                        ...
                        link = "[𐇮 𝙎𝙤𝙪𝙧𝙘𝙚 𝙋𝙧𝙤 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/zzzzl1l)"
                        text = (
                            "**✘ تقـريـر اشعـار زدثـــون 𝙎𝙤𝙪𝙧𝙘𝙚 𝙋𝙧𝙤 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار 𝙎𝙤𝙪𝙧𝙘𝙚 𝙋𝙧𝙤  ✘**\n\n "
